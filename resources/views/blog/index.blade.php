                    ...
                    @if (!empty($blogs) && count($blogs))
                        @foreach ($blogs as $blog)
                            <tr>
                                ...
                                <td>{{ $blog->judul }}</td>
                                <td>
                                    <img style="width: 100px;" src="{{ asset('images/blog/' . $blog->foto) }}" alt="Foto" class="mx-auto d-block">
                                </td>
                                <td class="text-center">
                                    <a href="{{ route('blog.show', $blog->id) }}" class="btn btn-info">Edit</a>
                                    <a href="javascript:void(0)" onclick="deleteData({{$blog->id}})" class="btn btn-danger">Hapus</a>
